...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("home", "Thong Ke", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("hoadon", "Hoa Don", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("voucher", "Vourcher", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("nhanvien", "Nhan Vien", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("sanpham", "San Pham", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("khachhang", "Khach Hang", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("camera2", "QR", Model_Menu.MenuType.MENU));
